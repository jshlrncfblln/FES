	...
	<div class="row">
		<div class="col-md-4">
			<div class="card card-info card-primary">
				<div class="card-header" style="background-color: #f74780;">
					<b>Question Form</b>
				</div>
				<div class="card-body">
		...
		<div class="col-md-8">
			<div class="card card-outline card-info" style="border-top: #f74780;">
				<div class="card-header">
					<b>Academic Year: <?php echo $year . ' ' . ' | ' . (ordinal_suffix($semester)) ?> Semester</b>
							...
							<table class="table table-condensed">
								<thead>
									<tr class="bg-gradient-secondary">
										<th colspan="2" class=" p-1" style="vertical-align: middle;"><b><?php echo $crow['criteria'] ?></b></th>
